...
namespace S1ObjectDefinitions.GHZ
{
	class SwingingPlatform : ObjectDefinition
	{
		...
		{
			imgwreckingball = ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../artkosp/ghzball.kospm", CompressionType.Nemesis), "../_maps/obj48.asm", 1, 2);
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../artkosp/ghzswing.kospm", CompressionType.Nemesis), "../_maps/obj15ghz.asm", labels[i], i == 1 ? 0 : 2));
		}
