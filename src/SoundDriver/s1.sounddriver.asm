...
SoundPriorities:
		...
		dc.b $80,$70,$70,$70,$70,$70,$70,$70,$70,$70,$68,$70,$70,$70,$70,$70	; $A0
		dc.b $70,$70,$70,$70,$70,$70,$70,$70,$70,$70,$70,$60,$70,$70,$70,$70	; $B0
...
; Vladikcomper: Fixed deadlock on interrupts
...
; Sound_81to9F:
Sound_PlayBGM:
		cmpi.b	#$88,d7			; is the "extra life" music to be played?
...
SFX_BGMChannelRAM:
		dc.l (SoundDriverRAM+v_music_fm3_track)&$FFFFFF
		dc.l 0
		dc.l (SoundDriverRAM+v_music_fm4_track)&$FFFFFF
		dc.l (SoundDriverRAM+v_music_fm5_track)&$FFFFFF
		dc.l (SoundDriverRAM+v_music_psg1_track)&$FFFFFF
		dc.l (SoundDriverRAM+v_music_psg2_track)&$FFFFFF
		dc.l (SoundDriverRAM+v_music_psg3_track)&$FFFFFF	; Plain PSG3
		dc.l (SoundDriverRAM+v_music_psg3_track)&$FFFFFF	; Noise
; dword_722EC: SFXChannelRAM:
SFX_SFXChannelRAM:
		dc.l (SoundDriverRAM+v_sfx_fm3_track)&$FFFFFF
		dc.l 0
		dc.l (SoundDriverRAM+v_sfx_fm4_track)&$FFFFFF
		dc.l (SoundDriverRAM+v_sfx_fm5_track)&$FFFFFF
		dc.l (SoundDriverRAM+v_sfx_psg1_track)&$FFFFFF
		dc.l (SoundDriverRAM+v_sfx_psg2_track)&$FFFFFF
		dc.l (SoundDriverRAM+v_sfx_psg3_track)&$FFFFFF	; Plain PSG3
		dc.l (SoundDriverRAM+v_sfx_psg3_track)&$FFFFFF	; Noise
; ===========================================================================
; ---------------------------------------------------------------------------
...
@Start:
		...
		dc.w  $6B,  $65,  $5F,  $5A,  $55,  $50,  $4B,  $47,  $43,  $40,  $3C,  $39
		dc.w  $36,  $33,  $30,  $2D,  $2B,  $28,  $26,  $24,  $22,  $20,  $1F,  $1D
		dc.w  $1B,  $1A,  $18,  $17,  $16,  $15,  $13,  $12,  $11,  0,    0,    0
...
Music8B:	include	"sound\music8B.asm"
		even
Music8C:	include "sound\EK\m46-Boss.asm";incbin	sound\sadv3-bosspinch.bin
		even
...
Music92:	incbin	sound\music92.bin
		even
Music93:	incbin	sound\music9F.bin
		even
...
SoundIndex:	dc.l SoundA0, SoundA1, SoundA2
		...
		dc.l SoundD0	; never reached, see `SpecSoundIndex`
