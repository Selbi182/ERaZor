...
STS_ClrObjRam:	move.l	d0,(a1)+
		...
		@transXLeft: = $80+(SCREEN_WIDTH/2)-@blockSize-8
		@transXRight: = @transXLeft+@transWidth-8
		@transY: = $124
	...
	if def(__WIDESCREEN__)
		...
		; even more which breaks the limit but covers everything
		adda.w	#$40,a0
		move.b	#2,(a0)
		move.b	#6,obRoutine(a0)
		move.w	#@transXRight+@transWidth+@blockSize,obX(a0)
		move.w	#@transY,obScreenY(a0)
		move.b	#1,obFrame(a0)
		...
		move.b	#2,(a0)
		move.b	#6,obRoutine(a0)
		move.w	#@transXLeft+@blockSize+8,obX(a0)
		move.w	#@transY+(@blockSize*5),obScreenY(a0)
		move.b	#2,obFrame(a0)

		adda.w	#$40,a0
		move.b	#2,(a0)
		move.b	#6,obRoutine(a0)
		move.w	#@transXRight+8,obX(a0)
		move.w	#@transY+(@blockSize*5),obScreenY(a0)
		move.b	#2,obFrame(a0)
...
; see Localization.asm for the actual texts
